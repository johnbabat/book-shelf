...
The project is a virtual bookshelf which allows books to be added, given a rating, updated and deleted.
The aim of this project is to practice writing good project documentation.
...
psql bookshelf_test < bookshelf.psql
python test_flaskr.py
```

This commands create the test database and populate it with reqired data.
The first time you run the tests, omit the dropdb command since the db has not yet been created.
